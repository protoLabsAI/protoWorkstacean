...
Agents report mutations via a `kind: "data"` artifact part on their terminal Task, using MIME type `application/vnd.protolabs.worldstate-delta+json` (defined in [`lib/types/worldstate-delta.ts`](../../lib/types/worldstate-delta.ts)). Each entry:
