...
- [Your first GOAP goal](\1/) — use a domain in a goal selector
- [Add goals and actions](\1/) — reference for selectors and operators
- [Explanation: world engine](\1/) — design rationale
