...
// ── release.published / review.* ─────────────────────────────────────────────

// Published by the GitHub integration plugin, so the shapes live in
// lib/types/events.ts (lib can't import src). Surfaced here so src consumers
// keep one home for bus payload types.
export type {
